...
//  PennyWise
//
//  Created by wangzhen on 16/12/19.
//  Copyright © 2016年 Caroline. All rights reserved.
//
...
class DrawIcon {
    ...
    class func drawPetIcon() -> UIBezierPath {
        ...
        let paw1 = UIBezierPath(ovalInRect: CGRect(x: 130, y: 174,
            width: 140, height: 154))
        let paw2 = UIBezierPath(ovalInRect: CGRect(x: 71, y: 104,
            width: 71, height: 89))
        let paw3 = UIBezierPath(ovalInRect: CGRect(x: 161, y: 66,
            width: 71, height: 89))
        let paw4 = UIBezierPath(ovalInRect: CGRect(x: 254, y: 104,
            width: 71, height: 89))
